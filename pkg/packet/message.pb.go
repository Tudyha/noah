...
const file_pkg_packet_message_proto_rawDesc = "" +
	...
	"\x0enet_bytes_recv\x18\t \x01(\x01R\fnetBytesRecv\"8\n" +
	"\bErrorAck\x12\x12\n" +
	"\x04code\x18\x01 \x01(\x05R\x04code\x12\x18\n" +
	...
	" \x01(\x01R\x11inodesUsedPercentB\x11Z\x0fnoah/pkg/packetb\x06proto3"
...
var file_pkg_packet_message_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_pkg_packet_message_proto_goTypes = []any{
	(*Message)(nil),       // 0: packet.Message
	(*Login)(nil),         // 1: packet.Login
	(*ClientInfo)(nil),    // 2: packet.ClientInfo
	(*LoginAck)(nil),      // 3: packet.LoginAck
	(*Ping)(nil),          // 4: packet.Ping
	(*ErrorAck)(nil),      // 5: packet.ErrorAck
	(*Logout)(nil),        // 6: packet.Logout
	(*DiskUsageStat)(nil), // 7: packet.DiskUsageStat
	(*anypb.Any)(nil),     // 8: google.protobuf.Any
}
var file_pkg_packet_message_proto_depIdxs = []int32{
	8, // 0: packet.Message.body:type_name -> google.protobuf.Any
	2, // 1: packet.Login.client_info:type_name -> packet.ClientInfo
